...
const PHASE_CONFIG = {
  COMPRESSION: {
    ...
    hint: 'Priset samlar energi. Vänta på breakout med volym och ATR-expansion.',
  },
  IMPULSE_START: {
    icon: '🚀',
    label: 'Impulse Start',
    labelSv: 'Impulse Start',
    cls: 'wave-impulse-start',
    badgeCls: 'badge-green',
    hint: 'Breakout påbörjad. Volym bekräftar rörelsen. Wave 1 — vänta på pullback för bra entry.',
  },
  IMPULSE_CONTINUATION: {
    ...
    badgeCls: 'badge-blue',
    hint: 'Trenden fortsätter (trolig Wave 3). Entry kan vara sen — vänta på pullback eller ny continuation-trigger.',
  },
  PULLBACK_CORRECTION: {
    icon: '↩️',
    label: 'Pullback',
    labelSv: 'Pullback / Korrektion',
    cls: 'wave-pullback',
    badgeCls: 'badge-orange',
    hint: 'Pullback mot SMA20 — trenden är intakt. Wave 2 eller 4. Bra bevakningsläge för ny entry.',
  },
  EXHAUSTION_RISK: {
    icon: '⚠️',
    label: 'Exhaustion Risk',
    labelSv: 'Exhaustion Risk',
    cls: 'wave-exhaustion',
    badgeCls: 'badge-red',
    hint: 'Rörelsen är stark men börjar bli utsträckt. Var försiktig med sena entries — risk för reversal.',
  },
  CHOPPY_UNKNOWN: {
    icon: '❓',
    label: 'Choppy',
    ...
    cls: 'wave-choppy',
    badgeCls: 'badge-gray',
    hint: 'Ingen tydlig fas. Vänta på klarhet innan entry.',
  },
};
