...
const NAV_GROUPS = [
  {
    ...
    label: 'Trading OS',
    items: [
      { path: '/paper-trading', label: 'Låtsashandel', subtitle: 'Paper-only trades', icon: '◌', match: ['/paper-trading'], accent: 'green' },
      { path: '/daytrading', label: 'Daytrading', subtitle: 'Snabb researchvy', icon: '◔', match: ['/daytrading'], accent: 'orange' },
      { path: '/supervisor', label: 'Kontrollrum', subtitle: 'Pipeline och systemöversikt', icon: '🧭', match: ['/supervisor'], accent: 'blue' },
      { path: '/narrow', label: 'Narrow State', subtitle: 'Smala marknadslägen', icon: '◐', match: ['/narrow'], accent: 'teal' },
      { path: '/system', label: 'System / Safety', subtitle: 'Systemskydd', icon: '🛡️', match: ['/system'], accent: 'purple', searchMatch: [] },
      { path: '/lab', label: 'Testlab', subtitle: 'Replay, batch och strategitest', icon: '🧪', match: ['/lab'], accent: 'orange' },
      { path: '/live', label: 'Live / Signaler', subtitle: 'Scanner och realtid', icon: '♥', match: ['/live'], accent: 'blue' },
      { path: '/insikter?tab=data-center', label: 'Data Center', subtitle: 'Datastatus och historik', icon: '◍', match: ['/insikter'], accent: 'teal', searchMatch: ['tab=data-center'] },
      { path: '/system?tab=logs', label: 'Systemloggar', subtitle: 'Varningar och loggar', icon: '◈', match: ['/system'], accent: 'purple', searchMatch: ['tab=logs'] },
      { path: '/system?tab=health', label: 'Systemhälsa', subtitle: 'Hälsokontroller', icon: '◎', match: ['/system'], accent: 'purple', searchMatch: ['tab=health'] },
    ],
  },
];
