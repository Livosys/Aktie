    ...
    <OverviewPanel eyebrow="Performance" title="Strategy Performance">
      <FieldGrid
        items={[
          ...
          { label: 'Wins', value: hasValue(performance.wins) ? fmtNumber(performance.wins) : '—' },
          { label: 'Losses', value: hasValue(performance.losses) ? fmtNumber(performance.losses) : '—' },
          ...
          { label: 'Unrealized PnL', value: hasValue(performance.unrealizedPnl) ? fmtNumber(performance.unrealizedPnl, 2) : '—' },
