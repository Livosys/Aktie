...
const DEFAULT_GROUPS = {
  ...
  us_micro_futures: { label: 'US Micro Futures', label_sv: 'US Micro Futures', enabled: true, maxSymbols: 5, max_symbols: 5, priority: 13, mode: 'observe', paperEnabled: false, paper_enabled: false, batch_enabled: false, replay_enabled: true, live_enabled: false, observeOnly: true, risk_level: 'very_high', test_only: true, section: 'test', data_status: 'needs_provider', description_sv: 'CME micro E-mini futures (MNQ/MES). Endast replay-test, ingen riktig marknadsdata inkopplad än.', warning_sv: 'CME micro futures har hävstång. Endast testläge, ingen riktig data.', provider_hint_sv: 'Kräver CME/IB futures-datakälla (Fas 1).', color: '#f43f5e', ...GROUP_SAFETY },
...
const DEFAULT_SYMBOLS = [
  ...
  { symbol: 'MNQ', marketGroup: 'us_micro_futures', group: 'us_micro_futures', enabled: false, paused: false, priority: 1, testMode: 'observe', mode: 'observe', paper_enabled: false, live_enabled: false, underlying: 'Nasdaq 100', root: 'MNQ', tv_symbol: 'CME_MINI:MNQ1!', product_type: 'micro_future', currency: 'USD', contract_size: 2, tick_size: 0.25, tick_value_usd: 0.50, risk_level: 'very_high', test_only: true, placeholder: true, verification_status: 'unverified', data_status: 'needs_provider', status_label_sv: 'Väntar på futures-data', ...GROUP_SAFETY },
  { symbol: 'MES', marketGroup: 'us_micro_futures', group: 'us_micro_futures', enabled: false, paused: false, priority: 2, testMode: 'observe', mode: 'observe', paper_enabled: false, live_enabled: false, underlying: 'S&P 500', root: 'MES', tv_symbol: 'CME_MINI:MES1!', product_type: 'micro_future', currency: 'USD', contract_size: 5, tick_size: 0.25, tick_value_usd: 1.25, risk_level: 'very_high', test_only: true, placeholder: true, verification_status: 'unverified', data_status: 'needs_provider', status_label_sv: 'Väntar på futures-data', ...GROUP_SAFETY },
