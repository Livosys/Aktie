...
function main() {
  ...
  const out = {
    ...
    plan: result.plan ? {
      ...
      dateWindowRequested: result.plan.dateWindowRequested,
      dateWindowSelected: result.plan.dateWindowSelected,
      dateWindowAvailability: result.plan.dateWindowAvailability,
      freshnessStatus: result.plan.freshnessStatus,
      alreadyTestedWindows: result.plan.alreadyTestedWindows,
      windowSelectionReason: result.plan.windowSelectionReason,
